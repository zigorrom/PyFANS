...
class MainView(main_view_base, main_view, uih.DataContextWidget):
    ...
    def setupBinding(self):
        ...
        self.equivalent_resistance = uih.Binding(self.ui_equivalent_resistance,"text", sourceObject, "equivalent_resistance", converter=uih.StringToIntConverter(),validator=QtGui.QIntValidator())
        self.temperature = uih.Binding(self.ui_temperature,"text", sourceObject, "temperature", converter=uih.StringToIntConverter(),validator=QtGui.QIntValidator())
