...
# Form implementation generated from reading ui file 'UI_TimetraceExtractor_v2.ui'
#
...
class Ui_TimetraceExtractor(object):
    def setupUi(self, TimetraceExtractor):
        ...
        self.label_3 = QtGui.QLabel(self.ui_use_timetrace_settings)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_3.addWidget(self.label_3, 5, 0, 1, 1)
        self.ui_decimation_type = QtGui.QComboBox(self.ui_use_timetrace_settings)
        self.ui_decimation_type.setObjectName(_fromUtf8("ui_decimation_type"))
        self.ui_decimation_type.addItem(_fromUtf8(""))
        self.ui_decimation_type.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.ui_decimation_type, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ui_convert_all, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ui_select_measurement_data_file, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ui_open_measurement_data_file, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ui_measurement_data_filename, 2, 0, 1, 3)
        self.label = QtGui.QLabel(TimetraceExtractor)
        ...
        self.gridLayout.addWidget(self.ui_filename, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.ui_open_file, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ui_convert_file, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.ui_select_file, 2, 0, 1, 1)
        self.label_2 = QtGui.QLabel(TimetraceExtractor)
        ...
        QtCore.QObject.connect(self.ui_use_decimated_sample_rate, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.ui_decimation_type.setEnabled)
    ...
    def retranslateUi(self, TimetraceExtractor):
        ...
        self.label_3.setText(_translate("TimetraceExtractor", "Decimation Type", None))
        self.ui_decimation_type.setItemText(0, _translate("TimetraceExtractor", "Downsampling", None))
        self.ui_decimation_type.setItemText(1, _translate("TimetraceExtractor", "Downsampling+Filter", None))
        ...
        self.label.setText(_translate("TimetraceExtractor", "Measurement Data File:", None))
        ...
        self.label_2.setText(_translate("TimetraceExtractor", "Single Data File:", None))
